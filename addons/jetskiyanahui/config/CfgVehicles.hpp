...
class CfgVehicles {
	...
	class JetSkiYanahui : Zodiac {
		...
		class Sounds {
			class Engine {
				sound[] = {"\ca\sounds\Vehicles\Water\CRRC_PBX\ext-boat-engine-low-01", db0, 1.0, 300};
				frequency = "(randomizer*0.05+0.95)*rpm";
				volume = "engineOn*(thrust factor[0.7, 0.1])";
			};
			
			class EngineHighOut {
				sound[] = {"\ca\sounds\Vehicles\Water\CRRC_PBX\ext-boat-engine-high-01", db0, 0.8, 400};
				frequency = "(randomizer*0.05+0.95)*rpm";
				volume = "engineOn*(thrust factor[0.5, 1.3])";
			};
			
			class IdleOut {
				sound[] = {"\ca\SOUNDS\Vehicles\Water\CRRC_PBX\ext-boat-engine-idle-01", db-5, 1.0, 150};
				frequency = "1";
