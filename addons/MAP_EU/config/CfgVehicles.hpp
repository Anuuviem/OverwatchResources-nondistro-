...
class CfgVehicles {
	...
	class Land_Dam_Conc_20;	// External class reference
	...
	class Land_Dam_ConcP_20;	// External class reference
	...
	class Land_Dam_Barrier_40;	// External class reference
	...
	class Land_dum_istan3_hromada2;	// External class reference
	...
	class Land_dum_istan3_pumpa;	// External class reference
	...
	class Land_dum_olez_istan1;	// External class reference
	...
	class Land_dum_olez_istan2;	// External class reference
	...
	class Land_dum_olez_istan2_maly;	// External class reference
	...
	class Land_dum_olez_istan2_maly2;	// External class reference
	...
	class Land_sara_Domek_sedy;	// External class reference
	...
	class Land_sara_domek_zluty;	// External class reference
	...
	class Land_HouseV_1I1;	// External class reference
	...
	class Land_HouseV_1I1_dam;	// External class reference
	...
	class Land_HouseV_1I2;	// External class reference
	...
	class Land_HouseV_1I3;	// External class reference
	...
	class Land_HouseV_1I4;	// External class reference
	...
	class Land_HouseV_1L1;	// External class reference
	...
	class Land_HouseV_1L2;	// External class reference
	...
	class Land_HouseV_1T;	// External class reference
	...
	class Land_HouseV_2I;	// External class reference
	...
	class Land_HouseV_2L;	// External class reference
	...
	class Land_HouseV_2L_dam;	// External class reference
	...
	class Land_houseV_2T1;	// External class reference
	...
	class Land_houseV_2T2;	// External class reference
	...
	class Land_HouseV_3I1;	// External class reference
	...
	class Land_HouseV_3I2;	// External class reference
	...
	class Land_HouseV_3I3;	// External class reference
	...
	class Land_HouseV_3I4;	// External class reference
	...
	class Land_HouseV2_01A;	// External class reference
	...
	class Land_HouseV2_01A_dam;	// External class reference
	...
	class Land_HouseV2_01B;	// External class reference
	...
	class Land_HouseV2_01B_dam;	// External class reference
	...
	class Land_HouseV2_02;	// External class reference
	...
	class Land_HouseV2_02_Interier;	// External class reference
	...
	class Land_HouseV2_02_Interier_dam;	// External class reference
	...
	class Land_HouseV2_03;	// External class reference
	...
	class Land_HouseV2_03_dam;	// External class reference
	...
	class Land_HouseV2_03B;	// External class reference
	...
	class Land_HouseV2_03B_dam;	// External class reference
	...
	class Land_HouseV2_04;	// External class reference
	...
	class Land_HouseV2_04_interier;	// External class reference
	...
	class Land_HouseV2_04_interier_dam;	// External class reference
	...
	class Land_HouseV2_05;	// External class reference
	...
	class Land_HouseBlock_A1;	// External class reference
	...
	class Land_HouseBlock_A1_1;	// External class reference
	...
	class Land_HouseBlock_A1_2;	// External class reference
	...
	class Land_HouseBlock_A2;	// External class reference
	...
	class Land_HouseBlock_A2_1;	// External class reference
	...
	class Land_HouseBlock_A3;	// External class reference
	...
	class Land_HouseBlock_B1;	// External class reference
	...
	class Land_HouseBlock_B2;	// External class reference
	...
	class Land_HouseBlock_B3;	// External class reference
	...
	class Land_HouseBlock_B4;	// External class reference
	...
	class Land_HouseBlock_B5;	// External class reference
	...
	class Land_HouseBlock_B6;	// External class reference
	...
	class Land_HouseBlock_C1;	// External class reference
	...
	class Land_HouseBlock_C2;	// External class reference
	...
	class Land_HouseBlock_C3;	// External class reference
	...
	class Land_HouseBlock_C4;	// External class reference
	...
	class Land_HouseBlock_C5;	// External class reference
	...
	class Land_HouseBlock_D1;	// External class reference
	...
	class Land_HouseBlock_D2;	// External class reference
	...
	class Land_hut06;	// External class reference
	...
	class Land_Shed_wooden;	// External class reference
	...
	class Land_Shed_M01;	// External class reference
	...
	class Land_Shed_M02;	// External class reference
	...
	class Land_Shed_M03;	// External class reference
	...
	class Land_Shed_W01;	// External class reference
	...
	class Land_Shed_W02;	// External class reference
	...
	class Land_Shed_W03;	// External class reference
	...
	class Land_Shed_W4;	// External class reference
	...
	class Land_bouda3;	// External class reference
	...
	class Land_hut_old02;	// External class reference
	...
	class Land_Shed_Ind02;	// External class reference
	...
	class Land_Shed_Ind02_dam;	// External class reference
	...
	class Land_Barn_W_02;	// External class reference
	...
	class Land_Barn_W_01;	// External class reference
	...
	class Land_Barn_W_01_dam;	// External class reference
	...
	class Land_Barn_Metal;	// External class reference
	...
	class Land_Barn_Metal_dam;	// External class reference
	...
	class Land_Ind_Shed_01_main;	// External class reference
	...
	class Land_Ind_Shed_01_end;	// External class reference
	...
	class Land_Ind_Shed_02_main;	// External class reference
	...
	class Land_Ind_Shed_02_end;	// External class reference
	...
	class Land_sara_hasic_zbroj;	// External class reference
	...
	class Land_garaz_mala;	// External class reference
	...
	class Land_Ind_Garage01;	// External class reference
	...
	class Land_A_Office01;	// External class reference
	...
	class Land_A_Office02;	// External class reference
	...
	class Land_A_Office02_dam;	// External class reference
	...
	class Land_a_stationhouse;	// External class reference
	...
	class Land_A_GeneralStore_01;	// External class reference
	...
	class Land_A_GeneralStore_01a;	// External class reference
	...
	class Land_A_GeneralStore_01_dam;	// External class reference
	...
	class Land_A_GeneralStore_01a_dam;	// External class reference
	...
	class Land_A_Pub_01;	// External class reference
	...
	class Land_Farm_Cowshed_a;	// External class reference
	...
	class Land_Farm_Cowshed_a_dam;	// External class reference
	...
	class Land_Farm_Cowshed_b;	// External class reference
	...
	class Land_Farm_Cowshed_b_dam;	// External class reference
	...
	class Land_Farm_Cowshed_c;	// External class reference
	...
	class Land_Farm_Cowshed_c_dam;	// External class reference
	...
	class Land_Farm_WTower;	// External class reference
	...
	class Land_stodola_old_open;	// External class reference
	...
	class Land_sara_stodola3;	// External class reference
	...
	class Land_Nasypka;	// External class reference
	...
	class Land_A_BuildingWIP;	// External class reference
	...
	class Land_A_CraneCon;	// External class reference
	...
	class Land_A_Crane_02a;	// External class reference
	...
	class Land_A_Crane_02b;	// External class reference
	...
	class Land_Misc_Cargo1Ao;	// External class reference
	...
	class Land_Misc_Cargo1B;	// External class reference
	...
	class Land_Misc_Cargo1Bo;	// External class reference
	...
	class Land_Misc_Cargo1C;	// External class reference
	...
	class Land_Misc_Cargo1D;	// External class reference
	...
	class Land_Misc_Cargo1E;	// External class reference
	...
	class Land_Misc_Cargo1F;	// External class reference
	...
	class Land_Misc_Cargo1G;	// External class reference
	...
	class Land_Misc_Cargo2B;	// External class reference
	...
	class Land_Misc_Cargo2C;	// External class reference
	...
	class Land_Misc_Cargo2D;	// External class reference
	...
	class Land_Misc_Cargo2E;	// External class reference
	...
	class Land_Ind_Quarry;	// External class reference
	...
	class Land_Ind_SawMill;	// External class reference
	...
	class Land_Ind_SawMillPen;	// External class reference
	...
	class Land_Ind_Workshop01_01;	// External class reference
	...
	class Land_Ind_Workshop01_02;	// External class reference
	...
	class Land_Ind_Workshop01_03;	// External class reference
	...
	class Land_Ind_Workshop01_04;	// External class reference
	...
	class Land_Ind_Workshop01_box;	// External class reference
	...
	class Land_Ind_Workshop01_L;	// External class reference
	...
	class Land_Tovarna2;	// External class reference
	...
	class Land_Ind_Pec_01;	// External class reference
	...
	class Land_Ind_Pec_02;	// External class reference
	...
	class Land_Ind_Pec_03a;	// External class reference
	...
	class Land_Ind_Pec_03b;	// External class reference
	...
	class Land_Ind_Expedice_1;	// External class reference
	...
	class Land_ind_silomale;	// External class reference
	...
	class Land_Ind_SiloVelke_01;	// External class reference
	...
	class Land_Ind_SiloVelke_02;	// External class reference
	...
	class Land_Ind_SiloVelke_most;	// External class reference
	...
	class Land_Vez_Silo;	// External class reference
	...
	class Land_Ind_Vysypka;	// External class reference
	...
	class Land_D_Mlyn_Vys;	// External class reference
	...
	class Land_D_Pec_Vez1;	// External class reference
	...
	class Land_D_Pec_Vez2;	// External class reference
	...
	class Land_D_Vez_Mlyn;	// External class reference
	...
	class Land_D_VSilo_Pec;	// External class reference
	...
	class Land_Vez_Pec;	// External class reference
	...
	class Land_Ind_Mlyn_01;	// External class reference
	...
	class Land_Ind_Mlyn_02;	// External class reference
	...
	class Land_Ind_Mlyn_03;	// External class reference
	...
	class Land_Ind_Mlyn_04;	// External class reference
	...
	class Land_Ind_Mlyn_D1;	// External class reference
	...
	class Land_Ind_Mlyn_D2;	// External class reference
	...
	class Land_Ind_Stack_Big;	// External class reference
	...
	class Land_Ind_MalyKomin;	// External class reference
	...
	class Land_komin;	// External class reference
	...
	class Land_Misc_WaterStation;	// External class reference
	...
	class Land_Misc_PowerStation;	// External class reference
	...
	class Land_trafostanica_mala;	// External class reference
	...
	class Land_A_FuelStation_Shed;	// External class reference
	...
	class Land_Ind_TankSmall;	// External class reference
	...
	class Land_Ind_TankSmall2;	// External class reference
	...
	class Land_Ind_TankBig;	// External class reference
	...
	class Land_IndPipe2_big_18;	// External class reference
	...
	class Land_IndPipe2_big_18ladder;	// External class reference
	...
	class Land_IndPipe2_big_9;	// External class reference
	...
	class Land_IndPipe2_big_ground1;	// External class reference
	...
	class Land_IndPipe2_big_ground2;	// External class reference
	...
	class Land_IndPipe2_big_support;	// External class reference
	...
	class Land_IndPipe2_bigBuild1_L;	// External class reference
	...
	class Land_IndPipe2_bigBuild1_R;	// External class reference
	...
	class Land_IndPipe2_bigBuild2_L;	// External class reference
	...
	class Land_IndPipe2_bigBuild2_R;	// External class reference
	...
	class Land_IndPipe2_bigL_L;	// External class reference
	...
	class Land_IndPipe2_bigL_R;	// External class reference
	...
	class Land_IndPipe2_Small_9;	// External class reference
	...
	class Land_IndPipe2_Small_ground1;	// External class reference
	...
	class Land_IndPipe2_Small_ground2;	// External class reference
	...
	class Land_IndPipe2_SmallBuild1_L;	// External class reference
	...
	class Land_IndPipe2_SmallBuild1_R;	// External class reference
	...
	class Land_IndPipe2_SmallBuild2_L;	// External class reference
	...
	class Land_IndPipe2_SmallBuild2_R;	// External class reference
	...
	class Land_IndPipe2_SmallL_L;	// External class reference
	...
	class Land_IndPipe2_SmallL_R;	// External class reference
	...
	class Land_IndPipe2_T_L;	// External class reference
	...
	class Land_IndPipe2_T_R;	// External class reference
	...
	class Land_IndPipe1_stair;	// External class reference
	...
	class Land_Church_01;	// External class reference
	...
	class Land_Church_02;	// External class reference
	...
	class Land_Church_02a;	// External class reference
	...
	class Land_Church_03;	// External class reference
	...
	class Land_Church_03_dam;	// External class reference
	...
	class Land_vysilac_FM2;	// External class reference
	...
	class Land_telek1;	// External class reference
	...
	class Land_A_TVTower_Base;	// External class reference
	...
	class Land_A_TVTower_Mid;	// External class reference
	...
	class Land_A_TVTower_Top;	// External class reference
	...
	class Land_A_MunicipalOffice;	// External class reference
	...
	class Land_A_statue01;	// External class reference
	...
	class Land_A_statue02;	// External class reference
	...
	class Land_A_Hospital;	// External class reference
	...
	class Land_A_Hospital_dam;	// External class reference
	...
	class Land_ZalChata;	// External class reference
	...
	class Land_HouseB_Tenement;	// External class reference
	...
	class Land_rails_bridge_40;	// External class reference
	...
	class Land_Rail_House_01;	// External class reference
	...
	class Land_rail_station_big;	// External class reference
	...
	class Land_loco_742_blue;	// External class reference
	...
	class Land_loco_742_red;	// External class reference
	...
	class Land_wagon_box;	// External class reference
	...
	class Land_wagon_flat;	// External class reference
	...
	class Land_wagon_tanker;	// External class reference
	...
	class Land_Rail_Semafor;	// External class reference
	...
	class Land_Rail_Zavora;	// External class reference
	...
	class Land_Mil_Guardhouse;	// External class reference
	...
	class Land_Mil_Barracks;	// External class reference
	...
	class Land_Mil_Barracks_i;	// External class reference
	...
	class Land_Mil_Barracks_L;	// External class reference
	...
	class Land_Mil_House;	// External class reference
	...
	class Land_Mil_House_dam;	// External class reference
	...
	class Land_Mil_ControlTower;	// External class reference
	...
	class Land_Mil_ControlTower_dam;	// External class reference
	...
	class Land_SS_hangar;	// External class reference
	...
	class Land_A_Castle_Bastion;	// External class reference
	...
	class Land_A_Castle_Bergfrit;	// External class reference
	...
	class Land_A_Castle_Bergfrit_ruins;	// External class reference
	...
	class Land_A_Castle_Bergfrit_dam;	// External class reference
	...
	class Land_A_Castle_Donjon;	// External class reference
	...
	class Land_A_Castle_Donjon_dam;	// External class reference
	...
	class Land_A_Castle_Gate;	// External class reference
	...
	class Land_A_Castle_Stairs_A;	// External class reference
	...
	class Land_A_Castle_Wall1_20;	// External class reference
	...
	class Land_A_Castle_Wall1_20_Turn;	// External class reference
	...
	class Land_A_Castle_Wall1_Corner;	// External class reference
	...
	class Land_A_Castle_Wall1_Corner_2;	// External class reference
	...
	class Land_A_Castle_Wall1_End;	// External class reference
	...
	class Land_A_Castle_Wall1_End_2;	// External class reference
	...
	class Land_A_Castle_Wall2_30;	// External class reference
	...
	class Land_A_Castle_Wall2_Corner;	// External class reference
	...
	class Land_A_Castle_Wall2_Corner_2;	// External class reference
	...
	class Land_A_Castle_Wall2_End;	// External class reference
	...
	class Land_A_Castle_Wall2_End_2;	// External class reference
	...
	class Land_A_Castle_WallS_10;	// External class reference
	...
	class Land_A_Castle_WallS_5_D;	// External class reference
	...
	class Land_A_Castle_WallS_End;	// External class reference
	...
	class Land_A_Castle_Bastion_ruins;	// External class reference
	...
	class Land_A_Castle_Donjon_ruins;	// External class reference
	...
	class Land_A_Castle_Gate_ruins;	// External class reference
	...
	class Land_A_Castle_Stairs_A_ruins;	// External class reference
	...
	class Land_A_Castle_Wall1_20_ruins;	// External class reference
	...
	class Land_A_Castle_Wall1_20_Turn_ruins;	// External class reference
	...
	class Land_A_Castle_Wall1_Corner_ruins;	// External class reference
	...
	class Land_A_Castle_Wall1_Corner_2_ruins;	// External class reference
	...
	class Land_A_Castle_Wall1_End_ruins;	// External class reference
	...
	class Land_A_Castle_Wall1_End_2_ruins;	// External class reference
	...
	class Land_A_Castle_Wall2_30_ruins;	// External class reference
	...
	class Land_A_Castle_Wall2_Corner_ruins;	// External class reference
	...
	class Land_A_Castle_Wall2_Corner_2_ruins;	// External class reference
	...
	class Land_A_Castle_Wall2_End_ruins;	// External class reference
	...
	class Land_A_Castle_Wall2_End_2_ruins;	// External class reference
	...
	class Land_A_Castle_WallS_10_ruins;	// External class reference
	...
	class Land_A_Castle_WallS_5_D_ruins;	// External class reference
	...
	class Land_A_Castle_WallS_End_ruins;	// External class reference
	...
	class Land_ruin_corner_1;	// External class reference
	...
	class Land_ruin_corner_2;	// External class reference
	...
	class Land_ruin_wall;	// External class reference
	...
	class Land_ruin_walldoor;	// External class reference
	...
	class Land_ruin_chimney;	// External class reference
	...
	class Land_vez_ruins;	// External class reference
	...
	class Land_telek1_ruins;	// External class reference
	...
	class Land_leseni2x_ruins;	// External class reference
	...
	class Land_Nav_Boathouse_Pier_ruins;	// External class reference
	...
	class Land_Ind_TankSmall_ruins;	// External class reference
	...
	class Land_NAV_Lighthouse_ruins;	// External class reference
	...
	class Land_Ind_MalyKomin_ruins;	// External class reference
	...
	class Land_A_statue01_ruins;	// External class reference
	...
	class Land_Shed_W4_ruins;	// External class reference
	...
	class Land_Nav_Boathouse_ruins;	// External class reference
	...
	class Land_Church_01_ruins;	// External class reference
	...
	class Land_Barn_W_02_ruins;	// External class reference
	...
	class Land_Shed_Ind02_ruins;	// External class reference
	...
	class Land_Barn_W_01_ruins;	// External class reference
	...
	class Land_Farm_WTower_ruins;	// External class reference
	...
	class Land_Ind_Mlyn_04_ruins;	// External class reference
	...
	class Land_Ind_SiloMale_ruins;	// External class reference
	...
	class Land_Ind_Pec_01_ruins;	// External class reference
	...
	class Land_Mil_ControlTower_ruins;	// External class reference
	...
	class Land_Ind_Mlyn_03_ruins;	// External class reference
	...
	class Land_rail_station_big_ruins;	// External class reference
	...
	class Land_Ind_Mlyn_01_ruins;	// External class reference
	...
	class Land_Ind_SiloVelke_02_ruins;	// External class reference
	...
	class Land_Nasypka_ruins;	// External class reference
	...
	class Land_R_HouseV_2L;	// External class reference
	...
	class Land_HouseBlock_B3_ruins;	// External class reference
	...
	class Land_HouseBlock_C5_ruins;	// External class reference
	...
	class Land_ruin_01;	// External class reference
	...
	class Land_HouseBlock_B2_ruins;	// External class reference
	...
	class Land_R_Farm_Cowshed_a;	// External class reference
	...
	class Land_R_A_GeneralStore_01a;	// External class reference
	...
	class Land_Ind_Mlyn_02_ruins;	// External class reference
	...
	class Land_HouseBlock_D1_ruins;	// External class reference
	...
	class Land_Church_02_ruins;	// External class reference
	...
	class Land_SS_hangar_ruins;	// External class reference
	...
	class Land_Ind_Expedice_1_ruins;	// External class reference
	...
	class Land_Barn_Metal_ruins;	// External class reference
	...
	class Land_Ind_Vysypka_ruins;	// External class reference
	...
	class Land_Church_03_ruins;	// External class reference
	...
	class Land_a_stationhouse_ruins;	// External class reference
	...
	class Land_R_Shed_Ind02;	// External class reference
	...
	class Land_dum_zboreny_total;	// External class reference
	...
	class Land_R_HouseV_1I1;	// External class reference
	...
	class Land_R_Barn_W_01;	// External class reference
	...
	class Land_R_HouseV2_02;	// External class reference
	...
	class Land_R_HouseV2_04;	// External class reference
	...
	class Land_R_HouseV2_03B;	// External class reference
	...
	class Land_HouseBlock_A2_1_ruins;	// External class reference
	...
	class Land_HouseBlock_A2_ruins;	// External class reference
	...
	class Land_HouseBlock_C1_ruins;	// External class reference
	...
	class Land_HouseBlock_A3_ruins;	// External class reference
	...
	class Land_Ind_Quarry_ruins;	// External class reference
	...
	class Land_A_MunicipalOffice_ruins;	// External class reference
	...
	class Land_Ind_Stack_Big_ruins;	// External class reference
	...
	class Land_A_Hospital_ruins;	// External class reference
	...
	class Land_A_BuildingWIP_ruins;	// External class reference
	...
	class Land_HouseB_Tenement_ruins;	// External class reference
	...
	class Land_afdum_mesto2L;	// External class reference
	...
	class Land_Ind_TankBig_ruins;	// External class reference
	...
	class Land_dum_zboreny;	// External class reference
	...
	class Land_kostel_trosky;	// External class reference
	...
	class Land_HouseBlock_B1_ruins;	// External class reference
	...
	class Land_HouseBlock_B6_ruins;	// External class reference
	...
	class Land_Church_05R;	// External class reference
	...
	class Land_R_Barn_Metal;	// External class reference
	...
	class Land_bouda3_ruins;	// External class reference
	...
	class Land_Shed_M02_ruins;	// External class reference
	...
	class Land_Ind_Workshop01_box_ruins;	// External class reference
	...
	class Land_Shed_M03_ruins;	// External class reference
	...
	class Land_hut06_ruins;	// External class reference
	...
	class Land_Ind_Workshop01_03_ruins;	// External class reference
	...
	class Land_Ind_Workshop01_02_ruins;	// External class reference
	...
	class Land_Ind_Shed_02_main_ruins;	// External class reference
	...
	class Land_Shed_M01_ruins;	// External class reference
	...
	class Land_Shed_W03_ruins;	// External class reference
	...
	class Land_Misc_WaterStation_ruins;	// External class reference
	...
	class Land_HouseV_1I3_ruins;	// External class reference
	...
	class Land_garaz_mala_ruins;	// External class reference
	...
	class Land_ruin_rubble;	// External class reference
	...
	class Land_Majak_ruins;	// External class reference
	...
	class Land_Dulni_bs_ruins;	// External class reference
	...
	class Land_repair_center_ruins;	// External class reference
	...
	class Land_Dum_m2_ruins;	// External class reference
	...
	class Land_HouseV_1I4_ruins;	// External class reference
	...
	class Land_Hlidac_budka_ruins;	// External class reference
	...
	class Land_Cihlovej_dum_ruins;	// External class reference
	...
	class Land_HouseV_1I2_ruins;	// External class reference
	...
	class Land_dum_rasovna_ruins;	// External class reference
	...
	class Land_zalchata_ruins;	// External class reference
	...
	class Land_domek_rosa_ruins;	// External class reference
	...
	class Land_Statek_kulna_old_ruins;	// External class reference
	...
	class Land_Komin_ruins;	// External class reference
	...
	class Land_Hruzdum_ruins;	// External class reference
	...
	class Land_Ind_Garage01_ruins;	// External class reference
	...
	class Land_Ind_Workshop01_01_ruins;	// External class reference
	...
	class Land_dum_olez_istan2_maly_ruins;	// External class reference
	...
	class Land_HouseV_3I2_ruins;	// External class reference
	...
	class Land_Dumruina_mini_ruins;	// External class reference
	...
	class Land_Dum_mesto2_ruins;	// External class reference
	...
	class Land_brana02nodoor_ruins;	// External class reference
	...
	class Land_HouseV_3I4_ruins;	// External class reference
	...
	class Land_trafostanica_velka_ruins;	// External class reference
	...
	class Land_Ind_Shed_01_end_ruins;	// External class reference
	...
	class Land_Deutshe_mini_ruins;	// External class reference
	...
	class Land_bouda1_ruins;	// External class reference
	...
	class Land_Rail_House_01_ruins;	// External class reference
	...
	class Land_budova5_ruins;	// External class reference
	...
	class Land_dum_istan3_pumpa_ruins;	// External class reference
	...
	class Land_dum_olez_istan2_ruins;	// External class reference
	...
	class Land_AFDum_mesto3_ruins;	// External class reference
	...
	class Land_HouseV_2I_ruins;	// External class reference
	...
	class Land_AFDum_mesto2_ruins;	// External class reference
	...
	class Land_Dum_mesto3_ruins;	// External class reference
	...
	class Land_HouseV_3I1_ruins;	// External class reference
	...
	class Land_HouseV_3I3_ruins;	// External class reference
	...
	class Land_HouseV_2T2_ruins;	// External class reference
	...
	class Land_stanice_ruins;	// External class reference
	...
	class Land_Ind_Workshop01_L_ruins;	// External class reference
	...
	class Land_Dum_mesto_ruins;	// External class reference
	...
	class Land_Statek_hl_bud_ruins;	// External class reference
	...
	class Land_Sara_domek_ruina_ruins;	// External class reference
	...
	class Land_HouseV_1T_ruins;	// External class reference
	...
	class Land_Farm_Cowshed_c_ruins;	// External class reference
	...
	class Land_dum01_ruins;	// External class reference
	...
	class Land_stodola_open_ruins;	// External class reference
	...
	class Land_Ind_Shed_01_main_ruins;	// External class reference
	...
	class Land_HouseV_2T1_ruins;	// External class reference
	...
	class Land_Sara_Hasic_zbroj_ruins;	// External class reference
	...
	class Land_HouseV_1I1_ruins;	// External class reference
	...
	class Land_AFDum_mesto2L_ruins;	// External class reference
	...
	class Land_kostel_ruins;	// External class reference
	...
	class Land_kostel3_ruins;	// External class reference
	...
	class Land_trafostanica_mala_ruins;	// External class reference
	...
	class Land_garaz_ruins;	// External class reference
	...
	class Land_Sara_stodola_ruins;	// External class reference
	...
	class Land_Dum_mesto2L_ruins;	// External class reference
	...
	class Land_sara_domek_vilka_ruins;	// External class reference
	...
	class Land_dum_mesto_in_ruins;	// External class reference
	...
	class Land_AFbarabizna_ruins;	// External class reference
	...
	class Land_budova4_ruins;	// External class reference
	...
	class Land_Deutshe_ruins;	// External class reference
	...
	class Land_AFHospoda_mesto_ruins;	// External class reference
	...
	class Land_dum_istan3_hromada2_ruins;	// External class reference
	...
	class Land_Sara_domek_sedy_ruins;	// External class reference
	...
	class Land_Sara_domek_podhradi_1_ruins;	// External class reference
	...
	class Land_dum_olezlina_ruins;	// External class reference
	...
	class Land_budova1_ruins;	// External class reference
	...
	class Land_dum_olez_istan1_ruins;	// External class reference
	...
	class Land_Panelak_ruins;	// External class reference
	...
	class Land_Sara_domek_kovarna_ruins;	// External class reference
	...
	class Land_Sara_domek_hospoda_ruins;	// External class reference
	...
	class Land_budova4_in_ruins;	// External class reference
	...
	class Land_Panelak2_ruins;	// External class reference
	...
	class Land_Sara_domek_zluty_ruins;	// External class reference
	...
	class Land_Panelak3_ruins;	// External class reference
	...
	class Land_stodola_old_open_ruins;	// External class reference
	...
	class Land_Sara_stodola3_ruins;	// External class reference
	...
	class Land_budova2_ruins;	// External class reference
	...
	class Land_hospital_ruins;	// External class reference
	...
	class Land_Misc_PowerStation_ruins;	// External class reference
	...
	class Land_Farm_Cowshed_b_ruins;	// External class reference
	...
	class Land_Ind_SiloVelke_01_ruins;	// External class reference
	...
	class Land_tovarna2_ruins;	// External class reference
	...
	class Land_Ind_Pec_03_ruins;	// External class reference
	...
	class Land_Farm_Cowshed_a_ruins;	// External class reference
	...
	class Land_Ind_Pec_02_ruins;	// External class reference
	...
	class Land_A_GeneralStore_01_ruins;	// External class reference
	...
	class Land_hangar_2_ruins;	// External class reference
	...
	class Land_A_Office01_ruins;	// External class reference
	...
	class Land_A_Office02_ruins;	// External class reference
	...
	class Land_Shed_W01_ruins;	// External class reference
	...
	class Land_HouseV_1L2_ruins;	// External class reference
	...
	class Land_HouseV_1L1_ruins;	// External class reference
	...
	class Land_HouseV_2L_ruins;	// External class reference
	...
	class Land_HouseV2_05_ruins;	// External class reference
	...
	class Land_dum_zboreny_ruins;	// External class reference
	...
	class Land_hut_old02_ruins;	// External class reference
	...
	class Land_HouseV2_04_ruins;	// External class reference
	...
	class Land_HouseV2_03B_ruins;	// External class reference
	...
	class Land_HouseBlock_B5_ruins;	// External class reference
	...
	class Land_HouseV2_01A_ruins;	// External class reference
	...
	class Land_HouseV2_01B_ruins;	// External class reference
	...
	class Land_HouseV2_02_ruins;	// External class reference
	...
	class Land_Mil_House_ruins;	// External class reference
	...
	class Land_HouseV2_03_ruins;	// External class reference
	...
	class Land_HouseBlock_A1_1_ruins;	// External class reference
	...
	class Land_Shed_wooden_ruins;	// External class reference
	...
	class Land_brana02nodoor;	// External class reference
	...
	class Land_statek_brana;	// External class reference
	...
	class Land_statek_brana_open;	// External class reference
	...
	class Land_Wall_Gate_Kolchoz;	// External class reference
	...
	class Land_Wall_Gate_Ind1_L;	// External class reference
	...
	class Land_Wall_Gate_Ind1_R;	// External class reference
	...
	class Land_Wall_Gate_Ind2A_L;	// External class reference
	...
	class Land_Wall_Gate_Ind2A_R;	// External class reference
	...
	class Land_Wall_Gate_Ind2B_L;	// External class reference
	...
	class Land_Wall_Gate_Ind2B_R;	// External class reference
	...
	class Land_Wall_Gate_Ind2Rail_L;	// External class reference
	...
	class Land_Wall_Gate_Ind2Rail_R;	// External class reference
	...
	class Land_Wall_Gate_Village;	// External class reference
	...
	class Land_plot_zed_drevo1_branka;	// External class reference
	...
	class Land_plot_zboreny;	// External class reference
	...
	class Land_Gate_Wood1_5;	// External class reference
	...
	class Land_Wall_Gate_Wood1;	// External class reference
	...
	class Land_Gate_wood2_5;	// External class reference
	...
	class Land_Plot_Ohrada_Pruchozi;	// External class reference
	...
	class Land_plot_istan1_rovny_gate;	// External class reference
	...
	class Land_Wall_CGry_5_D;	// External class reference
	...
	class Land_Gate_IndVar2_5;	// External class reference
	...
	class Land_Wall_CBrk_5_D;	// External class reference
	...
	class Land_zed_dira_civil;	// External class reference
	...
	class Land_kulna;	// External class reference
	...
	class Land_bouda_plech;	// External class reference
	...
	class Land_pumpa;	// External class reference
	...
	class Ladder;	// External class reference
	...
	class LadderLong;	// External class reference
	...
	class Land_leseni2x;	// External class reference
	...
	class Land_Stoplight01;	// External class reference
	...
	class Land_Stoplight02;	// External class reference
	...
	class Land_Company3_2;	// External class reference
	...
	class Land_sign_altar;	// External class reference
	...
	class Land_Sign_Bar_RU;	// External class reference
	...
	class Land_Sign_BES;	// External class reference
	...
	class Land_sign_TEC;	// External class reference
	...
	class Land_sign_ulgano;	// External class reference
	...
	class Land_SignB_Gov;	// External class reference
	...
	class Land_SignB_GovPolice;	// External class reference
	...
	class Land_SignB_GovSchool;	// External class reference
	...
	class Land_SignB_GovSign;	// External class reference
	...
	class Land_SignB_Hotel_CZ;	// External class reference
	...
	class Land_SignB_Hotel_CZ2;	// External class reference
	...
	class Land_SignB_Hotel_CZ3;	// External class reference
	...
	class Land_SignB_Pharmacy;	// External class reference
	...
	class Land_SignB_PostOffice;	// External class reference
	...
	class Land_SignB_Pub_CZ1;	// External class reference
	...
	class Land_SignB_Pub_CZ2;	// External class reference
	...
	class Land_SignB_Pub_CZ3;	// External class reference
	...
	class Land_SignB_Pub_RU1;	// External class reference
	...
	class Land_SignB_Pub_RU2;	// External class reference
	...
	class Land_SignB_Pub_RU3;	// External class reference
	...
	class Land_NAV_Lighthouse;	// External class reference
	...
	class Land_NAV_Lighthouse2;	// External class reference
	...
	class Land_majak_podesta;	// External class reference
	...
	class Land_majak2;	// External class reference
	...
	class Land_Nav_Boathouse;	// External class reference
	...
	class Land_Nav_Boathouse_Pier;	// External class reference
	...
	class Land_Nav_Boathouse_PierL;	// External class reference
	...
	class Land_Nav_Boathouse_PierR;	// External class reference
	...
	class Land_Nav_Boathouse_PierT;	// External class reference
	...
	class Land_molo_drevo_bs;	// External class reference
	...
	class Land_molo_drevo_end;	// External class reference
	...
	class land_nav_pier_c;	// External class reference
	...
	class land_nav_pier_c_270;	// External class reference
	...
	class land_nav_pier_c_90;	// External class reference
	...
	class land_nav_pier_c_big;	// External class reference
	...
	class land_nav_pier_C_L;	// External class reference
	...
	class land_nav_pier_C_L10;	// External class reference
	...
	class land_nav_pier_C_L30;	// External class reference
	...
	class land_nav_pier_C_R;	// External class reference
	...
	class land_nav_pier_C_R10;	// External class reference
	...
	class land_nav_pier_C_R30;	// External class reference
	...
	class land_nav_pier_c_t15;	// External class reference
	...
	class land_nav_pier_c_t20;	// External class reference
	...
	class land_nav_pier_c2;	// External class reference
	...
	class land_nav_pier_c2_end;	// External class reference
	...
	class land_nav_pier_F_17;	// External class reference
	...
	class land_nav_pier_F_23;	// External class reference
	...
	class land_nav_pier_m;	// External class reference
	...
	class land_nav_pier_m_1;	// External class reference
	...
	class Land_nav_pier_m_2;	// External class reference
	...
	class land_nav_pier_m_end;	// External class reference
	...
	class land_nav_pier_M_fuel;	// External class reference
	...
	class land_nav_pier_pneu;	// External class reference
	...
	class land_nav_pier_uvaz;	// External class reference
	...
	class Land_molo_beton;	// External class reference
	...
	class Land_molo_krychle;	// External class reference
	...
	class Land_LHD_1;	// External class reference
	...
	class Land_LHD_2;	// External class reference
	...
	class Land_LHD_3;	// External class reference
	...
	class Land_LHD_4;	// External class reference
	...
	class Land_LHD_5;	// External class reference
	...
	class Land_LHD_6;	// External class reference
	...
	class Land_LHD_house_2;	// External class reference
	...
	class Land_LHD_elev_R;	// External class reference
