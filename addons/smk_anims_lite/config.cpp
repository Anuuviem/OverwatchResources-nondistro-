...
class CfgMovesMaleSdr : CfgMovesBasic
{
	...
	class States 
	{
		...
		class smk_SpecStandRight : AmovPercMstpSlowWrflDnon
		{
			...
			actions = "RifleStandActions";
			duty = 0;
			file = "\smk_anims_lite\anims\special\smk_StandRight.rtm";
		...
		{
			file = "\smk_anims_lite\anims\special\smk_StandLeft.rtm";
			weaponIK = 1;
		...
		{
			duty = 0;
			file = "\smk_anims_lite\anims\special\smk_StandUp.rtm";
		...
		class smk_SpecStandDown : smk_SpecStandRight
		{
			...
			leftHandIKEnd = 0;
			file = "\smk_anims_lite\anims\special\smk_StandDown.rtm";
			aimPrecision = 4.700000;
			disableWeapons = 1;
		...
		{
			duty = 0;
			file = "\smk_anims_lite\anims\special\smk_StandTaunt.rtm";
			interpolationSpeed = 2;
		};

		class smk_HandsBase : AmovPercMstpSrasWrflDnon
		{
			file = "\smk_anims_lite\anims\smk_HandsBase.rtm";
		};

		class AwopPercMstpSgthWrflDnon_Start1 : Default
		{
			actions = "RifleLowStandActions";
			file = "\smk_anims_lite\anims\smk_CombatStand_GrenadeThrowStart.rtm";
			rightHandIKCurve[] = {
		...
		{
			file = "\smk_anims_lite\anims\smk_CombatStand_GrenadeThrowThrow.rtm";
			rightHandIKCurve[] = {
					0
			};
			leftHandIKCurve[] = {
		...
		{
			file = "\smk_anims_lite\anims\smk_CombatStand_GrenadeThrowEnd.rtm";
			speed = 1.110000;
			rightHandIKCurve[] = {
		...
		class AwopPknlMstpSgthWrflDnon_Start : Default
		{
			...
			file = "\smk_anims_lite\anims\smk_CombatCrouch_GrenadeThrowStart.rtm";
			speed = 0.870000;
			looped = 0;
			soundEnabled = 0;
			leaningFactorBeg = 0.750000;
		...
		{
			file = "\smk_anims_lite\anims\smk_CombatCrouch_GrenadeThrowThrow.rtm";
			speed = 4.330000;
			ConnectTo[] = {
		...
		{
			file = "\smk_anims_lite\anims\smk_CombatCrouch_GrenadeThrowEnd.rtm";
			speed = 0.800000;
			ConnectTo[] = {
		...
		class smk_JumpOver : AovrPercMstpSrasWrflDf
		{
			...
			looped = 0;
			speed = 0.930000;
			file = "\smk_anims_lite\anims\smk_JumpOver.rtm";
			rightHandIKBeg = 1;
			rightHandIKEnd = 1;
			leftHandIKCurve[] = {
		...
		{
			file = "\smk_anims_lite\anims\special\smk_CrouchRight.rtm";
			duty = 0.030000;
			collisionShape = "ca\Anims\Characters\data\Geom\Sdr\Pknl_Wrfl.p3d";
			showWeaponAim = 0;
		...
		{
			file = "\smk_anims_lite\anims\special\smk_CrouchDown.rtm";
		...
		{
			file = "\smk_anims_lite\anims\special\smk_CrouchUp.rtm";
			aimPrecision = 3.200000;
			InterpolationSpeed = 0.900000;
		};
		...
		{
			file = "\smk_anims_lite\anims\special\smk_CrouchTaunt.rtm";
			disableWeapons = 1;
			interpolationRestart = 1;
			InterpolationSpeed = 2;
			leftHandIKCurve[] = {
		...
		{
			file = "\smk_anims_lite\anims\special\smk_CrouchLeft.rtm";
		...
		{
			file = "\smk_anims_lite\anims\smk_CombatSit_st.rtm";
			duty = -0.700000;
			collisionShape = "ca\Anims\Characters\data\Geom\Sdr\Pknl_Wrfl.p3d";
			showWeaponAim = 1;
			enableOptics = 1;
		...
		{
			file = "\smk_anims_lite\anims\smk_TakeCoverHalfed.rtm";
			collisionShape = "smk_anims_lite\geom\ubl.p3d";
		...
		{
			file = "\smk_anims_lite\anims\smk_TakeCover.rtm";
			collisionShape = "smk_anims_lite\geom\pg.p3d";
			visibleSize = 0.250121;
			looped = 1;
		...
		{
			file = "\smk_anims_lite\anims\smk_TakeCoverUrbanProne.rtm";
			visibleSize = 0.250121;
			looped = 0;
			speed = 2.810000;
			duty = 1;
		...
		{
			file = "\smk_anims_lite\anims\smk_TakeCoverUrbanProne_st.rtm";
			collisionShape = "smk_anims_lite\geom\ubl.p3d";
			visibleSize = 0.250121;
			looped = 1;
			speed = 123123.507812;
		...
		{
			file = "\smk_anims_lite\anims\smk_TakeCoverUrbanProneRight_st.rtm";
			collisionShape = "smk_anims_lite\geom\ubr.p3d";
		...
		{
			file = "\smk_anims_lite\anims\smk_TakeCoverUrbanProneRightUp_st.rtm";
		...
		{
			file = "\smk_anims_lite\anims\smk_TakeCoverUrbanProneUp_st.rtm";
			visibleSize = 0.290121;
			looped = 1;
			speed = 123123.507812;
			duty = 0.010000;
		...
		{
			file = "\smk_anims_lite\anims\smk_TakeCoverUrbanProneBlind_st.rtm";
		...
		{
			file = "\smk_anims_lite\anims\smk_TakeCoverUrbanProneRightBlind_st.rtm";
			visibleSize = 0.120121;
			duty = 0.150000;
			enableOptics = 0;
			headBobMode = 5;
		...
		{
			file = "\smk_anims_lite\anims\smk_TakeCoverUrbanProneRightTop_st.rtm";
			visibleSize = 0.290121;
			duty = 0.005000;
		...
		{
			file = "\smk_anims_lite\anims\smk_TakeCoverGoLeft.rtm";
			collisionShape = "smk_anims_lite\geom\ubl.p3d";
			visibleSize = 0.250121;
			looped = 1;
			speed = 0.920000;
		...
		{
			file = "\smk_anims_lite\anims\smk_TakeCoverUrbanProneRight_L.rtm";
			collisionShape = "smk_anims_lite\geom\ubr.p3d";
			speed = 0.920000;
			duty = 1;
			aimprecision = 3.250000;
		...
		{
			file = "\smk_anims_lite\anims\smk_TakeCoverGoRight.rtm";
			visibleSize = 0.250121;
			looped = 1;
			speed = 0.920000;
			aimprecision = 3.250000;
		...
		{
			file = "\smk_anims_lite\anims\smk_TakeCoverUrbanProneRight_R.rtm";
			speed = 0.920000;
			duty = 1;
			aimprecision = 3.250000;
		};
		...
		{
			file = "\smk_anims_lite\anims\smk_Slide.rtm";
			visibleSize = 0.250121;
			looped = 0;
			soundEnabled = 1;
			speed = 0.790000;
		...
		{
			file = "\smk_anims_lite\anims\smk_Slide_end.rtm";
			collisionShape = "ca\Anims\Characters\data\Geom\Sdr\Pknl_Wrfl.p3d";
			showWeaponAim = 1;
			enableOptics = 1;
			visibleSize = 0.350122;
		...
		class smk_Crouch_to_Sit : TransAnimBase
		{
			...
			actions = "RifleSitKneelActions";
			file = "\smk_anims_lite\anims\smk_CombatCrouch_to_Sit.rtm";
			speed = 1.100000;
			leaningFactorBeg = 1;
			leaningFactorEnd = 1;
			interpolationRestart = 1;
		...
		class smk_Sit_to_Crouch : TransAnimBase
		{
			visibleSize = 0.100125;
			actions = "RifleSitKneelActions";
			file = "\smk_anims_lite\anims\smk_CombatSit_to_Crouch.rtm";
			speed = 1.100000;
			leaningFactorBeg = 1;
			leaningFactorEnd = 1;
			interpolationRestart = 2;
		...
		class smk_Prone_to_UrbanProne_Left : TransAnimBase
		{
			...
			actions = "RifleActions_UPL";
			collisionShape = "smk_anims_lite\geom\ubl.p3d";
			file = "\smk_anims_lite\anims\smk_TakeCoverUrbanProneLeft.rtm";
			speed = 1.000000;
			leaningFactorBeg = 1;
			leaningFactorEnd = 1;
			interpolationRestart = 2;
		...
		class smk_UrbanProne_Left_to_Prone : TransAnimBase
		{
			...
			collisionShape = "smk_anims_lite\geom\ubl.p3d";
			file = "\smk_anims_lite\anims\smk_TakeCoverComeback.rtm";
			speed = 0.900000;
			leaningFactorBeg = 1;
			leaningFactorEnd = 1;
			interpolationRestart = 2;
		...
		class smk_Prone_to_UrbanProne_Right : TransAnimBase
		{
			...
			collisionShape = "smk_anims_lite\geom\ubr.p3d";
			actions = "RifleActions_UPR";
			file = "\smk_anims_lite\anims\smk_TakeCoverUrbanProneRight.rtm";
			speed = 0.850000;
			leaningFactorBeg = 1;
			leaningFactorEnd = 1;
			interpolationRestart = 2;
		...
		class smk_UrbanProne_Right_to_Prone : TransAnimBase
		{
			...
			actions = "RifleProneActions";
			collisionShape = "smk_anims_lite\geom\ubr.p3d";
			file = "\smk_anims_lite\anims\smk_TakeCoverUrbanProneRightComeback.rtm";
			speed = 0.750000;
			leaningFactorBeg = 1;
			leaningFactorEnd = 1;
			interpolationRestart = 2;
...
class CfgGesturesMale 
{
	...
	class States 
	{
		...
		class WeaponMagazineReloadStand : Default
		{
			file = "\smk_anims_lite\anims\smk_HandsReload.rtm";
			looped = 0;
			speed = 0.460000;
			mask = "handsWeapon";
		...
		{
			file = "\smk_anims_lite\anims\smk_HandsGLReload.rtm";
			looped = 0;
			speed = 0.610000;
			mask = "handsWeapon";
			headBobStrength = 0.200000;
		...
		{
			file = "\smk_anims_lite\anims\smk_HandsMGReload.rtm";
			looped = 0;
			speed = 0.250000;
			mask = "handsWeapon";
			headBobStrength = 0.200000;
...
class CfgWeapons 
{
	...
	{
		handAnim[] = {
				"OFP2_ManSkeleton", "\smk_anims_lite\anims\smk_HandsBase.rtm"
		};
