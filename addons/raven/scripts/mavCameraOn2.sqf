                  ...
                  [
                           ...
                           if (_key == 49) then
                           {
                                    switch (mavVisionMode) do
                                    {
                                             ...
                                             case 1 : {camUseNVG false;false setCamUseTi 1;mavVisionMode = 0;cutText ['DTV','PLAIN DOWN',0]};
                                             case 2 : {camUseNVG true;mavVisionMode = 1;cutText ['NV','PLAIN DOWN',0]};
                                             case 3 : {camUseNVG false;false setCamUseTi 1;mavVisionMode = 0;cutText ['DTV','PLAIN DOWN',0]};
                                    };
